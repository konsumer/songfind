async function Module(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module['locateFile']) {
      return locateFile('echoprint.wasm')
    }
    return new URL('echoprint.wasm', import.meta.url).href
  }
  ...
  var __embind_register_void = (rawType, name) => {
    name = AsciiToString(name)
    registerType(rawType, { isVoid: true, name, fromWireType: () => undefined, toWireType: (destructors, o) => undefined })
  }
  ...
  var _malloc, _free, ___getTypeName, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, memory, __indirect_function_table, wasmMemory, wasmTable
